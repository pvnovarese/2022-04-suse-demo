...
LABEL org.opencontainers.image.title="2022-04-suse-demo"
LABEL org.opencontainers.image.description="Simple SLES15 image to test various policy rules with Anchore Enterprise."
...
RUN set -ex && \
    ...
    zypper -n install ruby nodejs10 npm10 curl gzip tar && \
